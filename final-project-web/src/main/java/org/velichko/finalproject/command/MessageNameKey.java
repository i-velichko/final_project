...
public class MessageNameKey {

    public static final String LOGIN_NOT_UNIQUE_KEY = "error.login.not.unique";
    public static final String EMAIL_NOT_UNIQUE_KEY = "error.email.not.unique";
    public static final String EMAIL_NOT_CORRECT_KEY = "error.email.not.correct";
