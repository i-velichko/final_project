  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="${abs_path}/pages/login.jsp" class="nav-link px-2 link-secondary">Home</a></li>
        ...
        <li><a href="#" class="nav-link px-2 link-dark">The road to Epam starts here</a></li>
      </ul>
